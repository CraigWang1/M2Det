model = dict(
    ...
    input_size = 512,
    init_net = True,
    pretrained = 'weights/vgg16_reducedfc.pth',   #I CHANGED THIS
    m2det_config = dict(
        backbone = 'vgg16',
...
train_cfg = dict(
    cuda = True,
    warmup = 5,
    per_batch_size = 8,   #I CHANGED THIS
...
COCOroot = os.path.join("/content/unzipped_dset/nodist_COCO/data/COCO/")   #######CHANGE THIS
